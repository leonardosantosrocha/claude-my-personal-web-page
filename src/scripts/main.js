...
const translations = {
    pt: {
        ...
        curriculum: {
            ...
            job1Position: 'Senior Data Engineer - Insurance',
            job1Company: 'Itaú Unibanco',
            job1Period: 'Mar 2026 - Presente (5 meses)',
            job1Desc: 'Construindo produtos e plataformas de dados escaláveis na AWS.',
            job2Position: 'Senior Analytics Engineer - Cards',
            job2Company: 'Itaú Unibanco',
            job2Period: 'Mar 2025 - Fev 2026 (1 ano)',
            job2Desc: 'Criação e melhoria de dashboards centralizados de indicadores. Desenvolvimento de melhores práticas em serviços AWS.',
            job3Position: 'Mid Level Analytics Engineer - Cards',
            job3Company: 'Itaú Unibanco',
            job3Period: 'Mar 2024 - Fev 2025 (1 ano)',
            job3Desc: 'Projetei produto de dados end-to-end processando 500M+ eventos diários. Construí pipelines para transformar dados de navegação brutos em métricas de comportamento do cliente.',
            job4Position: 'Entry Level Analytics Engineer - Cards',
            job4Company: 'Itaú Unibanco',
            job4Period: 'Jul 2022 - Fev 2024 (1 ano 8 meses)',
            job4Desc: 'Projetei aplicação web interna para padronizar documentação de projetos. Geração automatizada reduzindo esforço em 30% e aumentando cobertura para 95%.',
            job5Position: 'Data Analyst Intern - Insurance',
            job5Company: 'Itaú Unibanco',
            job5Period: 'Jan 2021 - Jun 2022 (1 ano 6 meses)',
            job5Desc: 'Projetei pipeline de dados automatizado para análise de retenção de clientes. Processei 100K+ contratos de seguros diariamente com entrega diária de dashboard.',
    ...
    en: {
        ...
        curriculum: {
            ...
            job1Position: 'Senior Data Engineer - Insurance',
            job1Company: 'Itaú Unibanco',
            job1Period: 'Mar 2026 - Present (5 months)',
            job1Desc: 'Building scalable data products and platforms on AWS.',
            job2Position: 'Senior Analytics Engineer - Cards',
            job2Company: 'Itaú Unibanco',
            job2Period: 'Mar 2025 - Feb 2026 (1 year)',
            job2Desc: 'Creation and improvement of centralized indicators dashboards. Development of best practices in AWS services.',
            job3Position: 'Mid Level Analytics Engineer - Cards',
            job3Company: 'Itaú Unibanco',
            job3Period: 'Mar 2024 - Feb 2025 (1 year)',
            job3Desc: 'Designed end-to-end data product processing 500M+ daily events. Built pipelines to transform raw navigation data into customer behavior metrics.',
            job4Position: 'Entry Level Analytics Engineer - Cards',
            job4Company: 'Itaú Unibanco',
            job4Period: 'Jul 2022 - Feb 2024 (1 year 8 months)',
            job4Desc: 'Designed internal web application to standardize project documentation. Automated generation reducing effort by 30% and increasing coverage to 95%.',
            job5Position: 'Data Analyst Intern - Insurance',
            job5Company: 'Itaú Unibanco',
            job5Period: 'Jan 2021 - Jun 2022 (1 year 6 months)',
            job5Desc: 'Designed automated data pipeline for customer retention analysis. Processed 100K+ insurance contracts daily with daily dashboard delivery.',
