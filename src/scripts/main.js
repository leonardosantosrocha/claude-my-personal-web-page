...
const translations = {
    pt: {
        ...
        curriculum: {
            ...
            job1Desc: 'Accomplished a criação de agentes de IA e pipelines big data na AWS ao projetar e implementar soluções de automação com Python, PySpark e Terraform, resultando em tarefas de squad simplificadas e suporte abrangente para o negócio de Seguros.',
            job2Position: 'Engenheiro de Analytics Sênior',
            job2Company: 'Itaú Unibanco',
            job2Period: '2025 - 2026',
            job2Desc: 'Accomplished uma redução de 35% nos custos da AWS Athena ao construir um pipeline abrangente de monitoramento e rastreamento de queries, e alcançou crescimento da equipe ao orientar tecnicamente dois estagiários que foram subsequentemente contratados como analistas de dados.',
            job3Position: 'Engenheiro de Analytics Pleno',
            job3Company: 'Itaú Unibanco',
            job3Period: '2024 - 2025',
            job3Desc: 'Accomplished a criação de um dashboard GA4 de alto desempenho processando 100 milhões de linhas diárias do app Itaú ao aproveitar AWS e PySpark, e impulsionou iniciativas de alfabetização de dados através de treinamentos alcançando NPS >80.',
            job4Position: 'Engenheiro de Analytics Júnior',
            job4Company: 'Itaú Unibanco',
            job4Period: '2022 - 2024',
            job4Desc: 'Accomplished uma redução de 35% no esforço de documentação ao construir uma página HTML/CSS/JS para padronização de projetos técnicos, e facilitou a adoção de data mesh ao impulsionar a implementação que melhorou a qualidade dos dados em toda a organização.',
            job5Position: 'Estagiário em Análise de Dados',
            job5Company: 'Itaú Unibanco',
            job5Period: '2021 - 2022',
            job5Desc: 'Accomplished uma melhoria de 15% na saúde dos pipelines ao implementar automações de qualidade de dados com Shell e SQL, e desenvolveu um pipeline de processamento que tratava 100K+ apólices de seguros diárias usando SAS e Tableau para analytics de negócio.',
    ...
    en: {
        ...
        curriculum: {
            ...
            job1Desc: 'Accomplished the creation of AI agents and big data pipelines on AWS by designing and implementing automation solutions with Python, PySpark, and Terraform, resulting in streamlined routine squad tasks and comprehensive support for the Insurance business.',
            job2Position: 'Senior Analytics Engineer',
            job2Company: 'Itaú Unibanco',
            job2Period: '2025 - 2026',
            job2Desc: 'Accomplished a 35% reduction in AWS Athena costs by building a comprehensive query monitoring and tracking pipeline, and achieved team growth by mentoring two interns who were subsequently hired as data analysts.',
            job3Position: 'Mid Level Analytics Engineer',
            job3Company: 'Itaú Unibanco',
            job3Period: '2024 - 2025',
            job3Desc: 'Accomplished the creation of a high-performance GA4 dashboard processing 100 million rows daily from the Itaú app by leveraging AWS and PySpark, and drove data literacy initiatives through trainings achieving NPS >80.',
            job4Position: 'Junior Analytics Engineer',
            job4Company: 'Itaú Unibanco',
            job4Period: '2022 - 2024',
            job4Desc: 'Accomplished a 35% reduction in documentation effort by building an HTML/CSS/JS page for technical project standardization, and facilitated data mesh adoption by driving implementation that improved data quality across the organization.',
            job5Position: 'Data Analyst Intern',
            job5Company: 'Itaú Unibanco',
            job5Period: '2021 - 2022',
            job5Desc: 'Accomplished a 15% improvement in pipeline health by implementing data quality automations with Shell and SQL, and developed a processing pipeline handling 100K+ insurance policies daily using SAS and Tableau for business analytics.',
